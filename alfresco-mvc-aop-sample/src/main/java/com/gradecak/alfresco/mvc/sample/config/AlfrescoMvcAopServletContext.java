...
@EnableWebMvc
@EnableAlfrescoMvcAop(basePackageClasses = { AlfrescoMvcAopController.class, AopService.class })
public class AlfrescoMvcAopServletContext implements WebMvcConfigurer {

	@Override
	public void addFormatters(FormatterRegistry formatterRegistry) {
		formatterRegistry.addConverter((Converter<String, NodeRef>) new Jackson2NodeRefDeserializer());
	}
}
